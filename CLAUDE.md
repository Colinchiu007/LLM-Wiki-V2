...
每次 commit 含功能改动（feat/fix）后、`git push` 前，必须主动检查并更新：

1. **CHANGELOG.md**：在顶部加新版本条目（v4.0.0 for v2 changes）
2. **README.md / README_zh.md**：新增功能或行为变化时在对应章节补一条
3. **版本号**：v2 改动用 v4.0.0+，v1 改动继续 v3.x 序列
